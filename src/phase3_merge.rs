...
impl FinalizationExecutor {
    ...
    fn extract_key_changes(&self, session: &ExperimentSession, _baseline: f64) -> Vec<String> {
...
mod tests {
    use super::*;
    #[test] fn test_finalization_executor_creation() { let executor = FinalizationExecutor::new(); drop(executor); }
}
