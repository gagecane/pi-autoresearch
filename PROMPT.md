...
- If there are no more tasks to do, your task is to research the code and discover tasks that need done. This can include refactoring, improved line and branch coverage, mutatation tests, contract tests, and new features, improve documentation in docs/, align specs in the specs/ folder with the code implementation, improve test suite runtime, etc. Add the tasks to tasks.md.
