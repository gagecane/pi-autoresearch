...
- REVIEW tasks take the highest priority. When doing a REVIEW task, carefully review the changes made for correctness. Do not make any code changes. If you have feedback, write it to feedback.md and mark the task as REVISE. If the task is completed without feedback, mark it as COMPLETE and your task is done.
