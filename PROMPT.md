...
- If there are no more tasks to do, research the code and discover tasks that need done. This can include refactoring, improved line and branch coverage, mutatation tests, contract tests, and new features. Add the tasks to tasks.md.
